					...
					<div class="box pull-up">
						<div class="box-body">
							<div class="row align-items-center">
								...
								<div class="col-6">
									<h4 class="counter text-center mb-0 fs-40">$ 124 <small class="text-danger ps-10"><i class="mdi mdi-arrow-down text-danger"></i> -7.45%</small></h4>
								</div>
								<div class="col-3">
									<a href="#" class="btn btn-success btn-sm float-end">Sale</a>
								</div>
								<div class="col-12">
					...
					<div class="box pull-up">
						<div class="box-body">
							<div class="row align-items-center">
								...
								<div class="col-6">
									<h4 class="counter text-center mb-0 fs-40">$ 845 <small class="text-success ps-10"><i class="mdi mdi-arrow-up text-success"></i> +5.45%</small></h4>
								</div>
								<div class="col-3">
									<a href="#" class="btn btn-danger btn-sm float-end">Purchase</a>
								</div>
								<div class="col-12">
					...
					<div class="box pull-up">
						<div class="box-body">
							<div class="row align-items-center">
								...
								<div class="col-3">
									<a href="#" class="btn btn-success btn-sm float-end">vehicle</a>
								</div>
								<div class="col-12">
					...
					<div class="box pull-up">
						<div class="box-body">
							<div class="row align-items-center">
								...
								<div class="col-3">
									<a href="#" class="btn btn-danger btn-sm float-end"><strong>Total Items</strong></a>
								</div>
								<div class="col-12">
